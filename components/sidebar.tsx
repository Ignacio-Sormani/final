...
export default function Sidebar({ menu }: { menu: MenuProps[] }) {
  const pathname = usePathname();

  return (
    <aside className="flex flex-col items-center h-screen sticky top-0 overflow-y-auto space-y-4 w-72 py-6 px-4 bg-primary text-primary-content">
